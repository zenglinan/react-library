...
export default function Test() {
    ...
    // }
    return (React.createElement("div", { className: "test", style: { width: '300px' } },
        React.createElement(Upload, { action: 'https://www.mocky.io/v2/5cc8019d300000980a055e76', defaultFileList: defaultFileList, name: 'fileName', data: { 'key': 'value' }, headers: { 'X-Powered-By': 'vikingship' }, 
            // accept='.jpg'
            multiple: true, drag: true },
